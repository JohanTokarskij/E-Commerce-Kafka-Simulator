                    ...
                    for message in msgs:
                        ...
                        for item in message.value['order_details']:
                            ...
                            if product_name not in product_counts:
                                product_counts[product_name] = {'quantity': 0, 'total': 0}
                            product_counts[product_name]['quantity'] += quantity
                            product_counts[product_name]['total'] += round((price * quantity), 2)
                        ...
                        if now.date() > current_date:
                            report_date = datetime.strptime(state['current_date'], '%Y-%m-%d')
